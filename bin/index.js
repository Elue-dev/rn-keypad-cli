...
`));
  log(source_default.gray(`This will add the Keypad component into your project...
`));
  const input = await askQuestion(source_default.cyanBright("Where do you want to add the source code? (default: components/Keypad): "));
...
\u2705 Keypad component added!`));
  log(source_default.gray(`You can now import it using:
`));
  log(source_default.cyan(`import Keypad from './${relativePath}';
`));
}
runCLI();
